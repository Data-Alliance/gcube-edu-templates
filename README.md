...
```
docker.io/chaeyoon08/edu-dl-tensorflow:latest
docker.io/chaeyoon08/edu-cv-pytorch:latest
docker.io/chaeyoon08/edu-ml-data:latest
docker.io/chaeyoon08/edu-nlp-hf:latest
docker.io/chaeyoon08/edu-rl-pytorch:latest
docker.io/chaeyoon08/edu-genai-sd:latest
docker.io/chaeyoon08/edu-llm-train:latest
docker.io/chaeyoon08/edu-audio-pytorch:latest
docker.io/chaeyoon08/edu-medical-monai:latest
docker.io/chaeyoon08/edu-geo-gdal:latest
docker.io/chaeyoon08/edu-gnn-pyg:latest
```
